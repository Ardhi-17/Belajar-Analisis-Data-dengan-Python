# Belajar-Analisis-Data-dengan-Python (E-Commerce)

**[E-Commerce Dashboard](https://subm123.streamlit.app)**
## Gambaran Umum
...
- notebook.ipynb: File ini digunakan untuk menganalisa Data.
- README.md: Dokumentasi File.
- url.txt : Tautan Dashboard Analisa Data

##
Akses dashboard dengan lokal host di  **http://localhost:8501**
